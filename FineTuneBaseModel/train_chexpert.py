...
def fine_tune(cfg, model, train_loader, valid_loader, device, class_weights=None):
    """
    Fine-tune the model with validation, early stopping, and logging via wandb
    """
    ...
    for epoch in range(cfg.TRAINING.EPOCHS):
        ...
        for step, (images, labels) in enumerate(pbar):
            ...
            # Log the loss of each step to wandb
            if step % 50 == 0: # Log in every 50 steps
        ...
        log_metrics.update(per_class_auc)
